...
% ============================================================
%  CERTIFICATION / COVER LETTER  (single page, both supervisors)
% ============================================================
\newpage
\thispagestyle{plain}
\setcounter{page}{1}
...
\noindent We, the undersigned supervisors, certify that the bachelor thesis of
Mr.\ \textbf{Nguyen Duy Ngoc} entitled
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  Hanoi, \rule{2.2cm}{0.4pt} 2026\\[1.6cm]
  \rule{5cm}{0.4pt}\\[4pt]
  \textbf{Dr.\ Tr\`{a}n \DJ{}\`{\i}nh Ch\'{\i}}\\
  External Supervisor
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
