...
\noindent I,
\makebox[0.72\textwidth]{\dotfill}
(supervisor's name), certify that the thesis/
internship report of Mr/Ms.\
\makebox[0.6\textwidth]{\dotfill}
(student's name) is qualified to be presented in the Internship Jury 2025--2026.

\vspace{4cm}

\begin{flushright}
  Hanoi, \textless date\textgreater\\[0.6cm]
