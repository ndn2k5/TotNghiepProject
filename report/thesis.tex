...
% Date: July 2026
%
% Compile with XeLaTeX (recommended for Vietnamese):
%   xelatex thesis.tex
%   bibtex thesis
%   xelatex thesis.tex
%   xelatex thesis.tex
...
\usepackage[english,vietnamese]{babel}   % English main, Vietnamese for accented names
...
% ── Typography ───────────────────────────────────────────────────────
\usepackage{lmodern}          % better font rendering than CM
...
{\large\bfseries UNIVERSITY OF SCIENCE AND TECHNOLOGY OF HANOI}\\[4pt]
{\large\bfseries DEPARTMENT OF INFORMATION AND COMMUNICATION TECHNOLOGY}

\vspace{1.2cm}

% USTH Logo placeholder — replace with actual logo file
% Obtain usth_logo.png from https://usth.edu.vn and place in report/figures/
\includegraphics[width=5cm]{figures/usth_logo.png}
...
\begin{tabular}{@{}ll}
  \textbf{External Supervisor:} & Dr.\ Tr\`{a}n \DJ{}ình Chí \\[8pt]
...
%  (One page per supervisor per USTH convention)
% ============================================================
\newpage
\thispagestyle{plain}
\setcounter{page}{1}          % roman numbering starts here
\pagenumbering{roman}

\vspace*{2cm}

\begin{center}
  {\Large\bfseries SUPERVISOR'S CERTIFICATION}
\end{center}
...
\noindent I, \textbf{Dr.\ Tr\`{a}n \DJ{}ình Chí} (External Supervisor),
certify that the bachelor thesis of Mr.\ \textbf{Nguyen Duy Ngoc} entitled
\emph{``Development of an Internal AI Chatbot for Company Knowledge Retrieval''}
is qualified to be presented before the Bachelor Thesis Jury 2025--2026.

\vspace{3cm}

\begin{flushright}
  Hanoi, \rule{3cm}{0.4pt} 2026

  \vspace{2cm}

  \textbf{Dr.\ Tr\`{a}n \DJ{}ình Chí}\\
  External Supervisor\\
  \textit{Signature:} \rule{4cm}{0.4pt}
\end{flushright}

% ── Second certification page (Internal Supervisor) ──────────────────
\newpage
\thispagestyle{plain}
...
\noindent I, \textbf{Dr.\ Tr\`{a}n Ho\`{a}ng T\`{u}ng} (Internal Supervisor),
certify that the bachelor thesis of Mr.\ \textbf{Nguyen Duy Ngoc} entitled
\emph{``Development of an Internal AI Chatbot for Company Knowledge Retrieval''}
is qualified to be presented before the Bachelor Thesis Jury 2025--2026.
...
\begin{flushright}
  ...
  \textbf{Dr.\ Tr\`{a}n Ho\`{a}ng T\`{u}ng}\\
  Internal Supervisor, USTH ICT\\
  \textit{Signature:} \rule{4cm}{0.4pt}
\end{flushright}
