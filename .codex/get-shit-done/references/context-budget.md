...
The keys live in `.codex/settings.json` (project) or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/INTERNSHIP/example internship/TotNghiepProject/.codex/settings.json` (global) — **not** in `.planning/config.json`:
