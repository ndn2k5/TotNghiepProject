...
<required_reading>
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/PROJEct/AI MODELS/TotNghiepProject/.claude
                  → checks D:/PROJEct/AI MODELS/TotNghiepProject/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done
                  → writes to D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/hooks/
...
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/common-bug-patterns.md
