...
Use template from `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/templates/UI-SPEC.md`
