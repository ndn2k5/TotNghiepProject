...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-tools query`. Use `node D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-tools query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```
