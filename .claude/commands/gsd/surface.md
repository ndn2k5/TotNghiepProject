...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/.gsd-surface.json`
(sibling to `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/PROJEct/AI MODELS/TotNghiepProject/.claude/skills`).
...
`D:/PROJEct/AI MODELS/TotNghiepProject/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/.gsd-surface.json`
Install profile marker: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/.gsd-profile`
Skill dirs: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/skills/gsd-*/`
Engine module: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
