...
<required_reading>
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/user-story-template.md
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/spidr-splitting.md
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
