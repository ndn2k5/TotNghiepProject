...
```bash
INIT=$(node "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
