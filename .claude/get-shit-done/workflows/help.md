...
- Saves timestamped note to `.planning/notes/` (or `C:/Users/wikiepeidia/OneDrive - caugiay.edu.vn/bài tập/usth/GEN14/INTERNSHIP/example internship/TotNghiepProject/.claude/notes/` globally)
