...
```
Agent(
  prompt="Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/templates/VALIDATION.md`
