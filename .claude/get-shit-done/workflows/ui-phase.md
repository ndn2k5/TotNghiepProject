...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-ui-checker.md for instructions.
