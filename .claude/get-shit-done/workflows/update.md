...
for cand in \
  ...
  "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/bin/gsd-tools.cjs"; do
...
global: `D:/PROJEct/AI MODELS/TotNghiepProject/.claude/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
