...
<required_reading>
@D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/references/ai-frameworks.md
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/PROJEct/AI MODELS/TotNghiepProject/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.claude/agents/gsd-eval-planner.md for instructions.
