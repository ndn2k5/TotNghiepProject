...
<!-- For checkpoint task examples and patterns, see @D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/references/checkpoints.md -->
...
See `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/workflows/verify-phase.md` for verification logic.
