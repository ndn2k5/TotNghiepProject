...
```bash
INIT=$(node "D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/templates/spec.md.
