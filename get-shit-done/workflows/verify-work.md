...
<template>
@D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/workflows/transition.md`.
...
- Follow @D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/workflows/diagnose-issues.md
