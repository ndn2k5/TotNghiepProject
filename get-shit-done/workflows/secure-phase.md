...
```
Agent(
  prompt="Read D:/PROJEct/AI MODELS/TotNghiepProject/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/templates/SECURITY.md`
