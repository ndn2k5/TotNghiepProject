...
```bash
INIT=$(node "D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/bin/gsd-tools.cjs" commit \
