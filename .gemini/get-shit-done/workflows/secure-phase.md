...
```
Agent(
  prompt="Read D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/templates/SECURITY.md`
