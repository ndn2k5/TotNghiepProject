...
INSTALL_JS_GLOBAL="D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
