...
<required_reading>
@D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/references/ai-frameworks.md
@D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/agents/gsd-eval-planner.md for instructions.
