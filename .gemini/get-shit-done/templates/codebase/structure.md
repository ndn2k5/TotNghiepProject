...
- Usage: Reference from command with `@D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
