...
Reference full template: `D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/PROJEct/AI MODELS/TotNghiepProject/.gemini/get-shit-done/templates/state.md`.
