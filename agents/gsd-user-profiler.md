...
<reference>
@D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/PROJEct/AI MODELS/TotNghiepProject/get-shit-done/references/user-profiling.md` to load:
